...
SUBSTYLE_OVERRIDE = {
    ...
    "Industrial": "Rock",  # also in Electronic, but here as Rock
    "Funk Metal": "Rock",
    "Rap Metal": "Rock",
...
# UI
# ---------------------------------------------------------------------------
with gr.Blocks(title="SGD Portable CUDA", css=CSS) as app:
    ...
    with gr.Row():
        with gr.Column(scale=3):
            ...
            <div style="display:flex;align-items:center;gap:10px;padding:16px 0 4px 0">
                {logo_html}
                <div>
                    <div style="font-size:1.35rem;font-weight:700">SGD Portable CUDA</div>
